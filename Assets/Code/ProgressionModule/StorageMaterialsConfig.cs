...
namespace Progression
{
    ...
    public class StorageMaterialsConfig : ScriptableObject
    {
        ...
        [SerializeField] private List<int> _materialAddingDeltaTime;
        ...
        public List<int> MaterialAddingDeltaTime { get => _materialAddingDeltaTime; set => _materialAddingDeltaTime = value; }
    }
}